...
| 题目                                                                                                                                                                     | 难度 | 类型             | 标注            |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--- | :--------------- | :-------------- |
| [148.排序链表](./LeetCode%E9%A2%98%E8%A7%A3/658.%E6%89%BE%E5%88%B0K%E4%B8%AA%E6%9C%80%E6%8E%A5%E8%BF%91%E7%9A%84%E5%85%83%E7%B4%A0.md)                      | 普通 | 单链表排序题       |     需熟悉链表的基本操作     |

### 单链表前插技巧
可通过交换data的方式将前插转变为后插
```javascript
// 将s插入到p前面
s.next = p.next
p.next = s
